...
.. py:currentmodule:: xobox.utils.dynamic

Dynamic Class
-------------

.. autoclass:: xobox.utils.dynamic.Dynamic
   :members:

   The constructor of the :py:class:`~xobox.utils.dynamic.Dynamic` class uses
...
The dynamic iterable class interface is much more complex than the pure :py:class:`~xobox.utils.dynamic.Dynamic`
...
In addition, the :py:class:`~xobox.utils.dynamic.Dynamic` class allows for registering hook methods or
functions, which can be used to manipulate the item setting and deletion behaviour.

.. autoclass:: xobox.utils.dynamic.DynamicIterable
   :members:

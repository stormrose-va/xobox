...
from xobox.utils.loader import detect_class_modules, load_member
...
class TestXoboxUtilsLoader(TestCase):
    """
    Unit tests for :py:mod:`xobox.utils.loader`
    ...
    def test_01(self):
        """
        Test Case 01:
        Detect existing classes in an existing artificial package tests environment.
    ...
    def test_02(self):
        """
        Test Case 02:
        Detect existing classes in an existing artificial module tests environment.
    ...
    def test_03(self):
        """
        Test Case 03:
        Detect non-existing classes in an existing artificial package tests environment.
    ...
    def test_04(self):
        """
        Test Case 04:
        Detect non-existing classes in a non-existing tests environment.
    ...
    def test_05(self):
        """
        Test Case 05:
        Load class from artificial tests environment.

...
from xobox.utils.singleton import Singleton
...
class TestXoboxUtilsSingleton(TestCase):
    """
    Unit tests for :py:mod:`xobox.utils.singleton`
    """

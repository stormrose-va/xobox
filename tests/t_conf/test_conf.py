...
from xobox.conf import get_conf, ApplicationConf


class TestXoboxConf(TestCase):
    """
    Unit tests for :py:mod:`xobox.conf`
    """

    def test_01(self):
        """
        Test Case 01:
        Test :py:mod:`xobox.conf` via the :py:func:`~xobox.conf.get_conf` function interface (valid key).
    ...
    def test_02(self):
        """
        Test Case 02:
        Test :py:mod:`xobox.conf` via the :py:func:`~xobox.conf.get_conf` function interface (invalid key).
    ...
    def test_03(self):
        """
        Test Case 03:
        Test the :py:class:`~xobox.conf.ApplicationConf` class interface via property interface.
    ...
    def test_04(self):
        """
        Test Case 04:
        Test the :py:class:`~xobox.conf.ApplicationConf` class interface via dictionary interface.
    ...
    def test_05(self):
        """
        Test Case 05:
        Test if the :py:class:`~xobox.conf.ApplicationConf` class interface provides also a non-default.
